...
const MENU={
  "Tandoori Pizzas":[
    ...
    {n:"Keema Fire Pizza",p:160,d:"Spiced minced meat, mozzarella, red onion, green chilli and herbs.",i:"1604382354936-07c5d99839bd"},
    {n:"Seafood Fire Pizza",p:165,d:"Prawns, squid, roasted tomato, chilli, garlic and mozzarella.",i:"1513104787528-97e6b0a4dd3b"},
    {n:"Four Cheese Tandoor Pizza",p:150,d:"A rich four-cheese blend finished with herbs.",i:"1513185583736-c8a7d9dda8e0"},
    {n:"Veggie Fire Pizza",p:135,d:"Roasted vegetables, mushrooms, olives, onion and mozzarella.",i:"1511689660939-ec234ee80d5c"}
  ],
  "Fire Kitchen":[
  ...
  "Desserts":[
    ...
    {n:"Fire-Roasted Pineapple",p:60,d:"Pineapple caramelised with heat and served warm.",i:"1550258978-83b179a25df8"},
  ...
  "Drinks":[
    ...
    {n:"Blue Lagoon",p:50,d:"A bright zero-alcohol citrus cooler.",i:"1560508179-b2c9a3f8e6b8"},
    {n:"Mint Lemon",p:35,d:"Fresh mint and lemon served chilled.",i:"1523677011781-c91d1bbe2f9e"},
    {n:"Saffron Sunset Cooler",p:50,d:"A saffron-led signature cooler.",i:"1553787499-6f9133860278"},
    {n:"Coconut Lime Cooler",p:45,d:"Coconut, lime and mint served cold.",i:"1553530666-ba11a7da3888"},
    {n:"Iced Latte",p:45,d:"Espresso with chilled milk over ice.",i:"1461023058943-07fcbe16d735"},
    {n:"Karak Chai",p:25,d:"Slow-brewed spiced milk tea.",i:"1531973576160-7125cd663d86"}
  ]
};